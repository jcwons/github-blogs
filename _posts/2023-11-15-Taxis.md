...
![A test image]({{ site.baseurl }}/docs/assets/taxi/locations_3.png)
...
![A test image]({{ site.baseurl }}/docs/assets/taxi/clusters_0.png)
...
![A test image]({{ site.baseurl }}/docs/assets/taxi/pickup_hours.png)
...
! Income vs number of hours
! Income per hour vs waiting time
