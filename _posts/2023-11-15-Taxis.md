...
![Heatmap of locations]({{ site.baseurl }}/docs/assets/taxi/locations_3.png)
...
![Income vs number of hours]({{ site.baseurl }}/docs/assets/taxi/total_earn.png)

![Income per hour vs waiting time]({{ site.baseurl }}/docs/assets/taxi/wait_average_earn.png)
